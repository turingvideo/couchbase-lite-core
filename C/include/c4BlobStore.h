...
extern "C" {
    ...
    C4BlobStore* c4db_getBlobStore(C4Database *db,
    ...
    bool c4blob_deleteStore(C4BlobStore*,
                            C4Error* C4NULLABLE outError) C4API;
    ...
    C4StringResult c4blob_getFilePath(C4BlobStore*,
                                      C4BlobKey,
                                      C4Error* C4NULLABLE error) C4API;
    ...
    bool c4blob_delete(C4BlobStore*,
                       C4BlobKey,
                       C4Error* C4NULLABLE error) C4API;
    ...
    int64_t c4stream_getLength(C4ReadStream*,
                               C4Error* C4NULLABLE error) C4API;
    ...
    C4WriteStream* c4blob_openWriteStream(C4BlobStore*, C4Error* C4NULLABLE error) C4API;

    /** Writes data to a stream. */
    bool c4stream_write(C4WriteStream*, const void *bytes, size_t length, C4Error* C4NULLABLE error) C4API;
